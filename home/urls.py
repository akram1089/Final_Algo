...
urlpatterns = [
    ...
    path('reset_pass_otp', views.reset_pass_otp, name='reset_pass_otp'),
    path('otp_update_pass', views.otp_update_pass, name='otp_update_pass'),
...
#     path('base', views.base, name='base'),
    ...
    path('sms_template', views.sms_template, name='sms_template'),
